...
/*
 * Standalone hybrid CUDA + CPU-threaded test build.
 * This file intentionally does not replace cuda_preprocessor.cu or the shared
 * library used by the full project.
 */
