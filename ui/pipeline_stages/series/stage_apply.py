...
class StageApply:
    ...
    def _run_pipeline(self):
        ...
        try:
            ...
            self.app.set_status(
                ...
                f"{len(headers)} columns, {t_elapsed:.3f}s"
            )
    ...
    # See: _apply_duplicates, _apply_missing, _apply_outliers, _apply_scaling, 
    #      _apply_encoding methods in PreprocessingPipeline class
